...
namespace Unity.Assets.Scenes.walker
{
    ...
    public class BodyPart
    {
        ...
        [HideInInspector] public MyJointDriveController thisJdController;
    ...
    public class MyJointDriveController : MonoBehaviour
    {
        //idher
        ...
        /// </summary>
        public void SetupBodyPart(Transform t,bool toAddGroundContact)
        {
            var bp = new BodyPart
            {
            ...
            // bp.groundContact.agentDoneOnGroundContact = toAddGroundContact;
