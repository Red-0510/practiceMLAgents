...
using System.Linq;
using System;
using BodyPart = Unity.Assets.Ragdoll.Agents.Scripts.BodyPart;
...
public static class JointHelper {
    ...
    public static Vector3 GetCenterOfMassRelativeToRoot(List<BodyPart> BodyParts) {
    ...
    public static Vector3 GetCenterOfMassWorld(List<BodyPart> BodyParts) {
        var centerOfMass = GetCenterOfMassRelativeToRoot(BodyParts) + BodyParts[0].InitialRootPosition;
        return centerOfMass;
    }

    public static Vector3 GetAngularMoment(List<BodyPart> BodyParts) {
